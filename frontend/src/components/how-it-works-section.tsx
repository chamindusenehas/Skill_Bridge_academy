...
const steps = [
  {
    ...
    details: [
      ...
      'Connect with GitHub or LinkedIn',
      ...
      <div className={cn(
        ...
        <div className={cn(
          ...
          <div className={cn(
            ...
            {/* Step number */}
            <div className={cn(
              'hidden lg:block absolute top-6 font-mono text-6xl font-bold opacity-10',
          ...
          {/* Arrow down between cards (mobile) */}
          {!isLast && (
    ...
    <section id="how-it-works" className="relative py-24 sm:py-32 overflow-hidden">
      ...
      <div ref={containerRef} className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 lg:mb-24">
          ...
          >
            Four simple steps to discover your perfect learning path with our 
