...
const questions = [
  {
    id: 'stem_level',
    question: 'What is your STEM knowledge level?',
    options: [
  ...
  {
    id: 'difficulty',
    question: 'Preferred course difficulty?',
    options: [
...
const recommendedCourses = [
  ...
  },
  {
    ...
    match: 94,
    tags: ['#DeepLearning', '#NeuralNets', '#PyTorch'],
    level: 'Advanced',
    duration: '12 weeks',
  },
  {
    ...
    match: 89,
    tags: ['#AIEthics', '#Applications', '#Research'],
    level: 'Intermediate',
    duration: '6 weeks',
  },
]
    ...
    <section className="relative py-24 sm:py-32 overflow-hidden bg-secondary/30">
      <div ref={containerRef} className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          >
            Answer a few questions and see how our Prolog-based AI engine recommends 
                ...
                {isProcessing && (
                  ...
                  >
                    ...
                    <p className="text-sm text-muted-foreground font-mono">
                      Running Prolog inference engine
                    </p>
                    
                    {/* Fake terminal output */}
                    <div className="mt-6 text-left bg-secondary/50 rounded-lg p-4 font-mono text-xs text-muted-foreground">
                      <motion.div
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        transition={{ delay: 0.2 }}
                      >
                        {`?- recommend(user_profile, Courses).`}
                      </motion.div>
                      <motion.div
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                  ...
                  >
                    <div className="text-center mb-8">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Based on your profile, here are your recommended courses
                      </p>
                    </div>
                      ...
                      {recommendedCourses.map((course, idx) => (
                        ...
                        >
                          <div className={cn(
                            ...
                            course.match >= 95 ? 'bg-green-500/20 text-green-500' :
                            course.match >= 90 ? 'bg-blue-500/20 text-blue-500' :
                          ...
                          <div className="hidden sm:flex flex-wrap gap-1 max-w-[150px]">
                            {course.tags.map((tag) => (
                              <span 
                                key={tag} 
                                className="text-[10px] text-primary font-mono bg-primary/10 px-1.5 py-0.5 rounded"
                              >
                                {tag}
                              </span>
                            ))}
        ...
        >
          {[
            ...
            { icon: Brain, title: 'Smart AI', desc: 'Powered by Prolog inference' },
          ].map((item, idx) => (
            <motion.div
              key={item.title}
              initial={{ opacity: 0, y: 20 }}
