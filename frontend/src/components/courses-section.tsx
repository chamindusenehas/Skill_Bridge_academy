...
const courses = [
  {
    ...
    students: 2340,
    rating: 4.9,
    hashtags: ['#DeepLearning', '#NeuralNetworks', '#PyTorch'],
  ...
  },
  {
    ...
    description: 'Learn to identify vulnerabilities and secure systems like a professional.',
    category: 'security',
    level: 'Advanced',
    duration: '10 weeks',
    students: 1850,
    rating: 4.8,
    hashtags: ['#EthicalHacking', '#PenTesting', '#Security'],
  ...
  },
  {
    ...
    description: 'Analyze data, build visualizations, and create ML models with Python.',
    category: 'data',
    level: 'Beginner',
    duration: '8 weeks',
    students: 4520,
  ...
  },
  {
    ...
    description: 'Build modern web applications with React, Next.js, and Node.js.',
    category: 'web',
    level: 'Intermediate',
    duration: '14 weeks',
    students: 3210,
    rating: 4.7,
    hashtags: ['#React', '#NextJS', '#FullStack'],
  ...
  },
  {
    ...
    students: 1980,
    rating: 4.8,
    hashtags: ['#AWS', '#CloudArchitecture', '#DevOps'],
  ...
  },
  {
    ...
    description: 'Connect devices, collect data, and build intelligent IoT ecosystems.',
    category: 'iot',
    level: 'Advanced',
    duration: '12 weeks',
    students: 980,
    rating: 4.6,
    hashtags: ['#IoT', '#Embedded', '#Sensors'],
      ...
      <div className={cn(
        ...
        <div className={cn(
          ...
          >
            <motion.div
              whileHover={{ scale: 1.1 }}
              className="p-4 rounded-full bg-white/30 backdrop-blur-sm cursor-pointer"
            >
        ...
        <div className="p-6 flex-1 flex flex-col">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            {course.hashtags.map((tag) => (
              <span 
                key={tag} 
                className="text-xs text-primary font-mono bg-primary/10 px-2 py-1 rounded-md"
              >
                {tag}
              </span>
            ))}
    ...
    <section id="courses" className="relative py-24 sm:py-32 overflow-hidden bg-secondary/30">
      <div ref={containerRef} className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          >
            Discover courses across cutting-edge technology domains, each tagged with 
            hashtags for our AI recommendation system.
          </motion.p>
        </div>
          ...
          {categories.map((category) => (
            <Button
              ...
              className={cn(
                ...
                activeCategory === category.id && 'bg-gradient-to-r from-primary to-accent'
              )}
            >
