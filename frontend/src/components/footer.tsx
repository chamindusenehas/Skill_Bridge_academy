  ...
  return (
    <footer ref={containerRef} className="relative bg-card border-t border-border/50 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Get notified about new courses, learning paths, and exclusive offers.
            </p>
            ...
            <div className="col-span-2 md:col-span-3 lg:col-span-2">
              ...
              >
                ...
                <p className="text-sm text-muted-foreground mb-6 max-w-xs">
                  AI-powered learning platform providing personalized course recommendations 
                  using symbolic AI technology.
                </p>
                ...
                <div className="space-y-3 text-sm text-muted-foreground">
                  <div className="flex items-center gap-2">
                    ...
                    <span>NIBM, Sri Lanka</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Mail className="w-4 h-4 text-primary" />
                    <span>contact@skillbridge.academy</span>
                  </div>
                  <div className="flex items-center gap-2">
        ...
        >
          <p>
            &copy; {new Date().getFullYear()} Skill-Bridge Academy. All rights reserved.
          </p>
